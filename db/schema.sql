CREATE TABLE IF NOT EXISTS scenarios (
  ...
  specialty_en TEXT NOT NULL DEFAULT 'Internal Medicine',
  ...
  disease_en TEXT NOT NULL DEFAULT '',
  patient_name_ru TEXT NOT NULL,
  patient_name_kk TEXT NOT NULL,
  patient_name_en TEXT NOT NULL DEFAULT '',
  ...
  chief_complaint_en TEXT NOT NULL DEFAULT '',
